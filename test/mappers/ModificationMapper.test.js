...
// Оставил только одного производителя
  ...
  const manufacturerMapper = new ManufacturerMapper(scope.cradle);
  const modelMapper = new ModelMapper(scope.cradle);
  const modificationMapper = new ModificationMapper(scope.cradle);
