export default class DefaultAdsApiAdapter {
  ...
  convert(data) {
    ...
    const result = {
      ...
      address: data.address ? data.address.substring(0, 250) : null,
      city: data.city ? data.city.substring(0, 250) : null,
      title: data.title ? data.title.substring(0, 1000) : null,
      adsDate: data.time,
      price: data.price,
      person: data.person ? data.person.substring(0, 250) : null,
