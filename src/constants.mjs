...
const TRANSMISSIONS = [
  { name: 'механика', code: 'MANUAL' },
  { name: 'автомат', code: 'AUTOMATIC' },
  { name: 'робот', code: 'ROBOTIC' },
